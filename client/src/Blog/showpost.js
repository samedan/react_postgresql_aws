...
class ShowPost extends Component {
  ...
  animate_comments = () => {
    ...
    this.state.comments_arr.map(comment => {
      ...
      setTimeout(() => {
        this.setState({
          comments_motion: [...this.state.comments_motion, comment]
        });
      }, 400 * i);
      i++;
    });
  ...
  handleCommentUpdate = comment => {
    const commentIndex = this.state.comments_motion.findIndex(
  ...
  handleLikes = () => {
    ...
    axios
      ...
      // user already liked it if 'like_post = true'
        ...
        <div>
          ...
          >
            ...
            <small
              ...
              style={{
                backgroundColor: this.state.like_post ? `green` : `gray`,
                color: this.state.like_post ? `white` : `gray`
              }}
            >
              {" "}
              {this.state.likes}{" "}
          ...
          {this.state.like_post ? null : <div>Already liked</div>}
        </div>
        <div>
          <h2> Comments:</h2>
          {/* {this.props.comments
